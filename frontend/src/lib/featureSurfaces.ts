...
const featureSeeds = [
  ...
  ["hoa-requests","HOA Requests","HOA Requests review queue","HOA Community Manager","Review source context and assign owner"],
  ["violation-notices","Violation Notices","Violation Notices review queue","HOA Community Manager","Confirm next action and update evidence"],
  ["board-packets","Board Packets","Board Packets review queue","HOA Community Manager","Confirm next action and update evidence"],
