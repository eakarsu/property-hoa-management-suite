...
export const sourceSystems = [
  { name: 'AIPropertyHOAManagementAssistant', ownership: 'Records source capabilities and workflows', coverage: ['Records', 'Workspaces', 'Requests'] },
  { name: 'AIPropertyHOAManagementOperations', ownership: 'Workspaces source capabilities and workflows', coverage: ['Cases', 'Schedules', 'Resources'] },
  { name: 'AIPropertyHOAManagementAnalytics', ownership: 'Requests source capabilities and workflows', coverage: ['Approvals', 'Exceptions', 'Compliance'] },
  { name: 'AIPropertyHOAManagementWorkflow', ownership: 'Cases source capabilities and workflows', coverage: ['Analytics', 'Forecasts', 'Reports'] },
];
