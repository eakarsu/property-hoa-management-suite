...
const features = [
  {
    ...
    summary: 'Records workflow normalized for the Property HOA Management suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Users,
    summary: 'Workspaces workflow normalized for the Property HOA Management suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: ClipboardList,
    summary: 'Requests workflow normalized for the Property HOA Management suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: CalendarCheck,
    summary: 'Cases workflow normalized for the Property HOA Management suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Activity,
    summary: 'Schedules workflow normalized for the Property HOA Management suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Workflow,
    summary: 'Resources workflow normalized for the Property HOA Management suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: FileText,
    summary: 'Approvals workflow normalized for the Property HOA Management suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: ShieldCheck,
    summary: 'Exceptions workflow normalized for the Property HOA Management suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: BarChart3,
    summary: 'Compliance workflow normalized for the Property HOA Management suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: PackageCheck,
    summary: 'Analytics workflow normalized for the Property HOA Management suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    icon: Bell,
    summary: 'Forecasts workflow normalized for the Property HOA Management suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Intelligence Layer',
    icon: Files,
    summary: 'Reports workflow normalized for the Property HOA Management suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    title: "HOA Requests",
    href: "/hoa-requests",
    category: "HOA Community Manager",
    icon: Workflow,
    summary: "Resident requests, architectural reviews, maintenance, and owner communication.",
    bullets: ["HOA Requests queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "HOA Requests", value: "28", note: 'Active' },
  ...
  },
  {
    ...
    href: "/violation-notices",
    category: "HOA Community Manager",
    icon: Workflow,
    summary: "Violation evidence, notice drafts, deadlines, and board review.",
    bullets: ["Violation Notices queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Violation Notices", value: "39", note: 'Active' },
  ...
  },
  {
    ...
    category: "HOA Community Manager",
    icon: Workflow,
    summary: "Meeting agenda, motions, financials, resident issues, and decision log.",
    bullets: ["Board Packets queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Board Packets", value: "50", note: 'Active' },
  ...
  },
  {
    ...
    icon: Files,
    summary: 'Property HOA Management documents, packets, evidence, attachments, and exports.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Bell,
    summary: 'Property HOA Management alerts, reminders, exceptions, and approvals.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Plug,
    summary: 'Property HOA Management source-system connector health and sync status.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: UserRound,
    summary: 'Property HOA Management users, roles, teams, permissions, and ownership settings.',
...
const aiFeatures = [
  {
    ...
    category: 'Intelligence Layer',
    icon: Bot,
    summary: 'Property HOA Management assistant for triage, summaries, drafting, recommendations, and operational review.',
...
export const featureFamilies = [
  ...
  { name: 'HOA Community Manager', features: ["HOA Requests","Violation Notices","Board Packets"] },
...
export const featureContexts: Record<string, FeatureContext> = Object.fromEntries(
  allFeatures.map((feature) => [
    feature.title,
    {
      sourceOwners: ['AIPropertyHOAManagementAssistant', 'AIPropertyHOAManagementOperations where applicable'],
