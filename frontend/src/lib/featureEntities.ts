...
const entitySeeds = [
  ...
  ["hoa-requests","HOA Requests Records","HOA Requests operating queue","Open","HOA Requests follow-up list","HOA Community Manager","$0"],
  ["violation-notices","Violation Notices Records","Violation Notices operating queue","Review","Violation Notices follow-up list","HOA Community Manager","$0"],
  ["board-packets","Board Packets Records","Board Packets operating queue","Review","Board Packets follow-up list","HOA Community Manager","$0"],
