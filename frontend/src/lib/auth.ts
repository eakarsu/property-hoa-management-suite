export const AUTH_COOKIE = 'property_hoa_management_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@property-hoa-management.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@property-hoa-management.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@property-hoa-management.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
