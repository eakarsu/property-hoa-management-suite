...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Property HOA Management Dashboard"
      subtitle="One merged property hoa management view for Records, Workspaces, Requests, Cases, Schedules, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared property hoa management jobs into one surface. Records, Workspaces, Requests, Cases, Schedules, Resources, documents, audit, and AI are presented as platform features.</div>
