...
PORT="${PORT:-5510}"
DB_NAME="${PGDATABASE:-property_hoa_management_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Property HOA Management Suite"
echo "======================================="
echo
...
echo "Starting property hoa management suite frontend on http://localhost:$PORT"
echo "Login: admin@property-hoa-management.local / admin123"
